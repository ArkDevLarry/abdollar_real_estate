                        ...
                        <div class="iq-card-body">
                           <div class="m-auto d-block text-center pb-3">
                              <div class="iq-user mb-3">
                                 <img class="avatar-70 rounded-circle" src="images/user/03.jpg" alt="">
                              </div>
                           ...
                           <ul class="d-flex align-items-center list-inline p-0 m-0 text-center">
                              ...
                              <li class="col-md-4">
                                 <div class="iq-user mb-3">
                                    <img class="avatar-70 rounded-circle" src="images/user/05.jpg" alt="">
                                 </div>
                              ...
                              <li class="col-md-4">
                                 <div class="iq-user mb-3">
                                    <img class="avatar-70 rounded-circle" src="images/user/07.jpg" alt="">
                                 </div>
                     ...
                     <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body p-0">
                           <ul class="list-inline p-0 m-0">
                              ...
                              <li class="d-flex align-items-center p-3 bg-white rounded">
                                 <div class="user-img img-fluid">
                                    <img src="images/user/05.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                                 </div>
                                 <div class="media-support-info ml-3">
                                    <h6>Joe Shestak</h6>
                  ...
                  <div class="col-lg-12">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <div class="dropdown">
                                 <span class="dropdown-toggle dropdown-bg iq-bg-primary" id="dropdownMenuButton2" data-toggle="dropdown" aria-expanded="false" role="button">
