...
<head>
<meta charset="utf-8">
<title>::Abdollar Homes & Consult::</title>
<!-- Stylesheets -->
...
<link rel="icon" href="images/ablogo.png" type="image/x-icon">
<!-- Responsive -->
                ...
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right clearfix">
                        <ul class="social-icon-one clearfix">
                            <li><a href="https://www.facebook.com/Abdollar-Homes-Consult-100932436054407/" target="_blank"><i class="la la-facebook-f"></i></a></li>
                ...
                <div class="clearfix">
                    ...
                    <div class="logo-outer">
                        <div class="logo">
                            <a href="index">
                                <!-- <br> -->
                                <!-- <h4>ABDOLLAR HOMES</h4> -->
                                <img src="images/ablogo.png" style="border-radius: 10px" width="120" height="120" alt="Abdollar Logo Main" title="Abdollar Logo">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="upper-right clearfix">
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                                ...
                                <li>Peak Apartment estate, Sanyinbo Awoyaya Lekki Lagos state.</li>
                            </ul>
...
<!--                                            <li><a href="login">Login</a></li>-->
                        ...
                        <div class="outer-box">
                           <div class="btn-box">
                               <a href="contact" class="theme-btn btn-style-four">Abdollar Homes</a>
                           </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index" title="">
                        <!-- <h4>ABDOLLAR HOMES</h4> -->
                        <img src="images/ablogo.png" style="border-radius: 10px" width="100" height="100" alt="Abdollar Logo Main" title="Abdollar Logo">
                        <!-- <img src="images/logo.png" width="100" height="100" alt="" title=""> -->
                    </a>
                </div>
                <!--Right Col-->
